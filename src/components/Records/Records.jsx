        ...
        <form id="nuevoPacienteForm">
          ...
          <fieldset>
            ...
            <div className="mb-3">
              ...
              />
              <small id="numeroTelefonico" className="form-text text-muted">
                Número o nombre de calle, altura. Ejemplo "Calle Falsa 123"{" "}
              </small>
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              <div className="radio-group">
                <input
                  ...
                  value="Sí"
                  onClick={() =>
                    toggleTextArea("anticonceptivosTextArea", true)
                  }
                />
                ...
                <input
                  ...
                  value="No"
                  onClick={() =>
                    toggleTextArea("anticonceptivosTextArea", false)
                  }
                />
            ...
            <div className="mb-3">
              ...
              <div className="radio-group">
                ...
                <input
                  ...
                  value="No"
                  onClick={() =>
                    toggleTextArea("intervencionesTextArea", false)
                  }
                />
          ...
          <fieldset>
            ...
            <div className="mb-3">
              <label className="form-label">
                ¿Autoriza a que MAB Estética tome fotografías confidenciales de
                su procedimiento estético con el único fin de observar los
                resultados y el avance de su tratamiento?
              </label>
              <div className="radio-group">
                <input
                  type="radio"
          ...
          <div className="form-check mt-3">
            ...
            <label className="form-check-label" htmlFor="declaracion">
              Declaro que toda la información brindada anteriormente es
              totalmente verídica.
            </label>
          </div>
          ...
          {/* Canvas para dibujar */}
          {/* <div className="mt-4">
                    <label htmlFor="drawingCanvas" className="form-label">Firme aquí:</label>
                    <canvas id="drawingCanvas" className="border" width="756" height="300"
                        style="border: 1px solid #000;"></canvas>
                    <button id="clearCanvasBtn" type="button" className="btn btn-danger mt-2">Borrar firma</button>
                </div> */}
